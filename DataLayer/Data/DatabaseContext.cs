...
namespace DataLayer.Data
{
    public partial class DatabaseContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // NewsArticle configuration (updated DeleteBehavior)
            modelBuilder.Entity<NewsArticle>(entity =>
            {
                ...
                // Updated relationships with Restrict
                ...
                entity.HasOne(d => d.UpdatedBy).WithMany(p => p.NewsArticleUpdatedBies)
                    ...
                    .OnDelete(DeleteBehavior.Restrict) // Changed from unspecified (Cascade if nullable)
                    .HasConstraintName("FK__NewsArtic__Updat__31EC6D26");

                // Many-to-many with Tags (unchanged)
            ...
            // SystemAccount configuration (unchanged)
